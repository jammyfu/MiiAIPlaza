...
- `bun test src/providers/mockPlazaPresence.test.ts src/providers/openClawPresenceAdapter.test.ts src/game/plaza/plazaResidentAvatarAdapter.test.ts` passes
